...
- **Discover** — find recipes and YouTube tutorials ranked by how many of your ingredients they use ([`/discover`](app/discover/page.tsx)). Scanned products link in two ways: a "Find recipes with this" button on the product detail page, and a "From your scans" picker right on the Discover page showing your whole scan history as tap-to-add/remove chips.
